...
import { useAuthUser, useAuthActions, useChats, useChatActions, useActiveChatId } from '@/store';
...
export default function Sidebar({ className, isMobile = false }: SidebarProps) {
  ...
  const currentChatId = useActiveChatId();
  ...
  const handleCreateChat = async () => {
    ...
    try {
      const chatId = await chatActions.createNewChat(user.id, 'New Chat');
