...
import { useAuthUser, useMessages, useChatActions } from '@/store';
...
export default function ChatWindow({ chatId }: ChatWindowProps) {
  ...
  const hasMore = false; // TODO: Implementar hasMore no chat slice
  ...
  useEffect(() => {
    ...
    const loadInitialMessages = async () => {
      ...
      try {
        await chatActions.loadMessages(chatId, true);
      } catch (error) {
  ...
  const handleLoadMore = async () => {
    ...
    try {
      ...
      await chatActions.loadMoreMessages();
